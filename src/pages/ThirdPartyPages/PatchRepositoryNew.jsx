            ...
            <div className="flex gap-4">
                ...
                <div className="flex-[2] bg-[#0B1220] border border-[#1e293b] rounded-xl overflow-hidden">
                    ...
                    <div className="p-4 border-b border-[#1e293b]">
                        <h1 className="text-lg font-semibold">📦 Third Party Package Catalog</h1>
                        <p className="text-xs text-gray-400">Manage application repository</p>
                    </div>

                    {/* SEARCH */}
                    <div className="p-4 flex flex-col md:flex-row gap-3 items-center border-b border-[#1e293b]">
                    ...
                    <div className="m-4 rounded-xl border border-[#1e293b] overflow-hidden">
                  ...
                  ${isSelected
                                        ...
                                        >
                                            <td className="px-4 py-3 font-medium">{item.appName}</td>
                                            <td className="px-4 py-3 text-gray-300">{item.latestVersion}</td>
                                            <td className="px-4 py-3 text-gray-300">{formatDateTime(item.updatedAt)}</td>
                                            ...
                                            <td className="px-4 py-3 text-center">
                                                <button
                                                    ...
                                                    className="w-8 h-8 rounded-lg bg-cyan-500/10 border border-cyan-500/20
                      hover:bg-cyan-500/20 flex items-center justify-center mx-auto"
                                                >
                ...
                {selectedApp && (
                    <div className="w-[420px] bg-[#0B1220] border border-[#1e293b] rounded-xl p-4 relative">
                        ...
                        <div className="flex items-center gap-3 mb-8">
                            ...
                            <h2 className="text-sm font-semibold text-cyan-400"> {selectedApp.appName}  </h2>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-2 mb-4">
                            <div className="bg-[#111827] border border-[#1e293b] rounded-lg p-3">
                                ...
                                <p className="text-xs text-cyan-400 font-medium"> {selectedApp.latestVersion} </p>
                            </div>

                            <div className="bg-[#111827] border border-[#1e293b] rounded-lg p-3">
                                <p className="text-[10px] text-gray-400">Updated At</p>
                                <p className="text-xs text-gray-300 font-medium"> {formatDateTime(selectedApp.updatedAt)} </p>
                            </div>
                        </div>
                        ...
                        <div className="bg-[#050B18] border border-[#1e293b] rounded-lg p-3">
                            ...
                            <code className="text-[12px] text-gray-300 break-all"> {selectedApp.silentcommand || "N/A"} </code>
                        </div>

                        <button className="mt-4 w-full bg-cyan-600/60 border border-cyan-600/60 hover:bg-cyan-500/30 hover:border-cyan-500/30
                            transition duration-200 text-cyan-300 text-xs py-2.5 rounded-lg flex items-center justify-center gap-2" >
