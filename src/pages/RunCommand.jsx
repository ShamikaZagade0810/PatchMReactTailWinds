        ...
        <div className="bg-[#0B1220] rounded-2xl p-6 border border-white/10 shadow-xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                    ...
                    <input className={inputClass} placeholder="Enter Activity Name" />
                </div>

                <div>
                    <label className={labelClass}> Activity Command </label>
                    <input className={inputClass} placeholder="Enter Activity Command" />
                </div>

                <div>
                    <label className={labelClass}>Activity Sub-Command </label>
                    <input className={inputClass} placeholder="Enter Activity Sub-Command" />
                </div>
            </div>
                            ...
                            >
                                ...
                                <td className="p-3 text-center">
                                    <div className="flex justify-center gap-2">
                                        ...
                                        {/* Edit Button */}
                                        <button className="px-2 py-1 text-xs text-blue-400 rounded-md hover:bg-blue-500/30 transition"
                                            onClick={() => handleEdit(item, index)} > <Pencil size={20} /> </button>

                                        {/* Delete Button */}
                                        <button className="px-2 py-1 text-xs  text-red-400 rounded-md hover:bg-red-500/30 transition"
                            ...
                            <div className="grid gap-4">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={(e) =>
                                            setEditData({ ...editData, ActivityName: e.target.value })
                                        }
                                    />
                                </div>
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={(e) =>
                                            setEditData({ ...editData, SubCommand: e.target.value })
                                        }
                                    />
                                </div>
